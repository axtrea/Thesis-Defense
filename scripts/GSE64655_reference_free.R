# ======================================================================
# Validation of reference-free deconvolution methods on GSE64655
# ======================================================================
# Dataset: Hoek purified melanoma dataset
# Task   : Compare reference-free deconvolution methods
# Metric : RMSE between estimated and true proportions
# ======================================================================
...
# ======================================================================
message("Loading GSE64655 data...")

tpm_file  <- "data/GSE64655/hoek_purified_tpm.rds"
facs_file <- "data/GSE64655/hoek_purified_facs.rds"

bulk_expr <- readRDS(tpm_file)
true_props <- as.matrix(readRDS(facs_file))

expr <- as.matrix(bulk_expr)
expr <- linearize_dataset(expr)
expr <- remove_zero_rows(expr)
...
estimated_list <- lapply(results, function(H) {
  H[1:nrow(true_props), , drop = FALSE]
})
